...
drivers. Driver 1 serves the front axle and Driver 2 serves the rear axle.
All numbers below are Raspberry Pi **BCM GPIO** numbers.

| Wheel | Driver input pair | Forward | Reverse |
| --- | --- | ---: | ---: |
| Front left | Driver 1 IN1 / IN2 | GPIO 5 | GPIO 6 |
| Front right | Driver 1 IN3 / IN4 | GPIO 16 | GPIO 19 |
| Rear left | Driver 2 IN1 / IN2 | GPIO 20 | GPIO 21 |
